...
<script>
  import Playground from '../../doc/Alert.svelte';
...
<Components.Dense file="Alert/dense" />
...
<Components.Transition file="Alert/transition" />
...
<Components.Text file="Alert/text" />
