...
<div class="_tp-hand _tp-hand-{ampm} {transitionClass}" style="transform: rotateZ({90 + degrees}deg);">
...
<style>
    ...
    {
        transition:transform .3s cubic-bezier(.4,0,.2,1) 0ms, height .3s cubic-bezier(.4,0,.2,1) 0ms
    }
    ._tp-hand-am{
        height:39.5%
    }
