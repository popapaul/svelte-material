...
import type { Datagrid, DatagridInstance } from "../index.svelte";
    ...
    transform() {
        ...
        for (let i = 0; i < this.grid.original.columns.length; i++) {
            ...
            const processedColumn: Column<TData> = {
                ...
                minWidth: columnDef.minWidth ?? 150, 
                maxWidth: columnDef.maxWidth ?? 200, 
                grow: columnDef.grow ??  !columnDef.width,
